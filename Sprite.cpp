...
#pragma region 頂点情報処理
    // 頂点データの設定
    vertices_.at(0) = { { -0.4f, -0.7f, 0.0f }, { 0.0f, 1.0f } }; // 左下
    vertices_.at(1) = { { -0.4f, +0.7f, 0.0f }, { 0.0f, 0.0f } }; // 左上
    vertices_.at(2) = { { +0.4f, -0.7f, 0.0f }, { 1.0f, 1.0f } }; // 右下
    vertices_.at(3) = { { +0.4f, +0.7f, 0.0f }, { 1.0f, 0.0f } }; // 右上
...
#pragma region ルートシグネチャ
    ...
    rootSignatureDesc.NumParameters = std::size(rootParams);
