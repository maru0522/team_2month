...
protected:
    ...
    DirectX::XMFLOAT3 radius_{1.0f,1.0f,1.0f}; // 座標中心点からの距離 ※半径
    Type type_{};
    uint32_t idxHook_{}; // Hookの番号
    uint32_t idxSupply_{}; // Supplyの番号
    uint32_t idxReceive_{}; // Receiveの番号
    uint32_t idxConnect_{}; // PowerReceiveとGimmickをつなぐもの
};